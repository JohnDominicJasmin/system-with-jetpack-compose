...
sealed class ResidentsAuthentication{
     ...
     class SuffixException(message: String) : RuntimeException(message)
     class SexException(message: String) : RuntimeException(message)
     ...
     class CivilStatusException(message: String): RuntimeException(message)
     ...
     class VoterException(message: String): RuntimeException(message)
     ...
     class SeniorCitizenException(message: String): RuntimeException(message)
